...
if __name__ == '__main__':
    ...
    # NbAFL-partial client K
    # selected client number in each iteration
    K = 20
    E = [50,60,100]
    for e in E:
        try:
            ...
            if e == 50:
                file = 'DPFL_e_50_partial.txt'
            elif e==60:
                file = 'DPFL_e_60_partial.txt'
            else:
                file = 'DPFL_e_100_partial.txt'
    ...
    try:
        ...
        device = torch.device("cpu")
        client = list(range(0, client_num, 1))
        file = 'Non_Private_diff_e_partial.txt'
