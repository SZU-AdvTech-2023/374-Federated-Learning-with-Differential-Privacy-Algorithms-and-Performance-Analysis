...
if __name__ == '__main__':
    ...
    fileName01 = 'DPFL_e_50.txt'
    x1, y1 = loaddata(fileName01)
    fileName011 = 'DPFL_e_60.txt'
    x11, y11 = loaddata(fileName011)
    fileName0111 = 'DPFL_e_100.txt'
    x111, y111 = loaddata(fileName0111)
    fileName02 = 'Non_Private_diff_e.txt'
    ...
    plt.tight_layout()
    plt.savefig("P1_Different_e_all_client.png")
    plt.show()
