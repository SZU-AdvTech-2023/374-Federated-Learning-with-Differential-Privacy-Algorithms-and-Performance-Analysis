...
delta = 0.01
data_len = 100
c = 2.5 *math.sqrt(2 * math.log(1.25 / (delta)))
L = 1
...
if __name__ == '__main__':
    ...
    # NbAFL-different T for different E
    E = [50,60,100]
    T = [5,10,15,20,25,30]
    for e in E:
        for total_iter in T:
            try:
                ...
                if e == 50:
                    if total_iter == 5:
                        file = 'DPFL_e_50_T_5.txt'
                    elif total_iter == 10:
                        file = 'DPFL_e_50_T_10.txt'
                    elif total_iter == 15:
                        file = 'DPFL_e_50_T_15.txt'
                    elif total_iter == 20:
                        file = 'DPFL_e_50_T_20.txt'
                    elif total_iter == 25:
                        file = 'DPFL_e_50_T_25.txt'
                    else:
                        file = 'DPFL_e_50_T_30.txt'

                elif e==60:
                    if total_iter == 5:
                        file = 'DPFL_e_60_T_5.txt'
                    elif total_iter == 10:
                        file = 'DPFL_e_60_T_10.txt'
                    elif total_iter == 15:
                        file = 'DPFL_e_60_T_15.txt'
                    elif total_iter == 20:
                        file = 'DPFL_e_60_T_20.txt'
                    elif total_iter == 25:
                        file = 'DPFL_e_60_T_25.txt'
                    else:
                        file = 'DPFL_e_60_T_30.txt'
                else:
                    if total_iter == 5:
                        file = 'DPFL_e_100_T_5.txt'
                    elif total_iter == 10:
                        file = 'DPFL_e_100_T_10.txt'
                    elif total_iter == 15:
                        file = 'DPFL_e_100_T_15.txt'
                    elif total_iter == 20:
                        file = 'DPFL_e_100_T_20.txt'
                    elif total_iter == 25:
                        file = 'DPFL_e_100_T_25.txt'
                    else:
                        file = 'DPFL_e_100_T_30.txt'
    ...
    for total_iter in T:
        try:
            ...
            client = list(range(0, client_num, 1))
            if total_iter == 5:
                file = 'Non_Private_T_5.txt'
            elif total_iter == 10:
                file = 'Non_Private_T_10.txt'
            elif total_iter == 15:
                file = 'Non_Private_T_15.txt'
            elif total_iter == 20:
                file = 'Non_Private_T_20.txt'
            elif total_iter == 25:
                file = 'Non_Private_T_25.txt'
            else:
                file = 'Non_Private_T_30.txt'
